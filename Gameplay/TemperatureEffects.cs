...
public class Weather_CalculateCurrentTemperature_Pre
{
    private static bool Prefix(Weather __instance)
    {
        ...
        /*
        if (__instance.m_CurrentTemperature < RnGl.glLastOutdoorTempNoBliz - m_CurrentBlizzardDegreesDrop)
        {
            __instance.m_CurrentTemperature = RnGl.glLastOutdoorTempNoBliz - m_CurrentBlizzardDegreesDrop;
        }
        

        Debug.Log("TEMP9: " + __instance.m_CurrentTemperature);

        __instance.m_CurrentTemperature = __instance.m_CurrentTemperature;
        */
